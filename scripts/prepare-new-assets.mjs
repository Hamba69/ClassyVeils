...
await sharp('public/brand/classyveils-refined.png').resize(512, 512, { fit: 'contain', background: '#fffaf4' }).png().toFile('src/app/icon.png');
await sharp('public/brand/classyveils-refined.png').resize(180, 180, { fit: 'contain', background: '#fffaf4' }).png().toFile('src/app/apple-icon.png');
await sharp('public/brand/classyveils-refined.png').resize(1200, 630, { fit: 'contain', background: '#fffaf4' }).png().toFile('src/app/opengraph-image.png');
